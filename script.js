const minBtn=document.querySelectorAll('.min-btn .palette-window');

minBtn.forEach(btn=> {
    btn.addEventListener('click',()=>{
      const parentWindow=btn.closest('.palette-window');
      if (parentWindow){
        parentWindow.classList.toggle("minimized");
      }
    });
});
...
3. Button animation on the toolbar was inspired by [this super cool list](https://dev.to/webdeasy/top-20-css-buttons-animations-f41) */